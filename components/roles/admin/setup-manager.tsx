          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm flex flex-col gap-5">
            ...
            {selectedYear ? (
              <div className="flex flex-col gap-5">
                {/* Tab Switchers */}
                <div className="flex gap-1.5 p-1 bg-slate-50 border border-slate-100 rounded-xl self-start">
                  <button
              ...
              <div className="rounded-xl border border-dashed border-slate-200 bg-slate-50/50 p-6 text-center text-sm text-slate-450">
...
function SectionsPanel({ year, sections }: { year: YearRow; sections: SectionRow[] }) {
  return (
    <div className="flex flex-col gap-4">
      <ul className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
        {sections.map((s) => (
          <li key={s.id} className="rounded-2xl border border-slate-200 bg-white p-5 flex items-center justify-between gap-3 shadow-sm hover:border-slate-300 transition-all">
            <div>
...
function SubjectsPanel({ year, subjects }: { year: YearRow; subjects: SubjectRow[] }) {
  return (
    <div className="flex flex-col gap-4">
      <ul className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
        {subjects.map((s) => (
          <li key={s.id} className="rounded-2xl border border-slate-200 bg-white p-5 flex flex-col gap-3 shadow-sm hover:border-slate-300 transition-all">
